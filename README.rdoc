...
For now, linking to the git repository should work with some deprecation messages :
    
    gem 'rails-footnotes', :github => 'josevalim/rails-footnotes', :group => :development
    
Then follow the steps for rails 3.

A new version is under active development, it will fully support Rails 4.x and retire Rails 2 / Ruby 1.8
